...
EXERCISES: list[dict] = [
    {
        ...
        "prompt": ("Read data/sales.csv and build `result` as a dict mapping each "
    ...
    },
    {
        ...
        "prompt": ("Fit a linear model on the training split, then set `y_pred` for "
    ...
    },
    {
        ...
        "prompt": ("Implement and train a tiny MLP (one hidden layer, numpy only) on "
...
MODULES: list[dict] = [
    ...
    {"id": "probability-inference", "title": "Module 3 · Probability & inference",
     "summary": "Random variables, sampling, CLT, hypothesis testing, correlation vs causation."},
    {"id": "regression-classification", "title": "Module 4 · Regression & classification",
     "summary": "Linear/logistic regression, regularization, scaling, kNN, trees."},
    {"id": "model-evaluation", "title": "Module 5 · Model evaluation & generalization",
     "summary": "Train/test split, leakage, cross-validation, over/underfitting, metrics."},
    {"id": "optimization-nn-fundamentals", "title": "Module 6 · Optimization & NN fundamentals",
     "summary": "Gradient descent, loss functions, backprop, perceptrons, MLPs."},
    {"id": "advanced-neural-networks", "title": "Module 7 · Advanced neural networks",
